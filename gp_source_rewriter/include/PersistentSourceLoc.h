...
#ifndef LLVM_PERSISTENTSOURCELOC_H
#define LLVM_PERSISTENTSOURCELOC_H
...
namespace GLitchPlease {
  ...
  private:
    static PersistentSourceLoc mkPSL(clang::SourceRange SR, clang::SourceLocation SL, clang::ASTContext &Context);
...
#endif //LLVM_PERSISTENTSOURCELOC_H
